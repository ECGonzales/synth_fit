...
# TODO: Is this for the Data Database? If so should the line above not be commented out?
    ...
    if plot:
        ...
        fig = plt.gcf()
        fig = plt.savefig('/Users/Dropbox/BDNYC/BDNYC_Research/Python/Modules/synth_fit/Run_outputs/Figures/{}_{}'
...
#        fig = plt.savefig('/Users/paigegiorla/Desktop/chains.eps')
    ...
    fb = open('/Users/Dropbox/BDNYC/BDNYC_Research/Python/Modules/synth_fit/Run_outputs/Figures/{}_{}'
...
#   fb = open('/Users/paigegiorla/Desktop/bdsamp.txt','wb')
   ...
   # fb = open('/Users/paigegiorla/Desktop/chain.pkl','wb')
    ...
    plt.savefig('/Users/Dropbox/BDNYC/BDNYC_Research/Python/Modules/synth_fit/Run_outputs/Figures/{}_{}'
